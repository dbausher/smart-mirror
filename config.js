var config = {
    ...
    speech : {
        ...
        sensitivity : 0.7, // keyword getting too many false positives or not detecting? Change this.
    ...
    greeting : {
       ...
       Daniel: ["Yo Daniel", "Hey Daniel", "Ayy Daniel"],
       Victor: ['Hey Victor', "Big V", "Mr. Oliveira"],
       Justin: ["Hello Justin!"],
       Mickey: ["Hi Mickey!"],
       Minnie: ["Hi Minnie!"]
